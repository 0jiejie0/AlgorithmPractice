package main.leetcode.editor.cn;//给你一个数组 nums 和一个值 val，你需要 原地 移除所有数值等于 val 的元素，并返回移除后数组的新长度。
//
...
// 快慢指针，内存消耗有点高，按理说应该比上题更低才对
//	执行耗时:0 ms,击败了100.00% 的Java用户
//	内存消耗:41 MB,击败了25.19% 的Java用户
// 不过有一点，从别人的题解发现，这道题和上道题的不同在于，这里不要求元素有序，可以使用双指针，减少交换次数。果然，真的更快一些
//	执行耗时:0 ms,击败了100.00% 的Java用户
//	内存消耗:40.8 MB,击败了77.29% 的Java用户