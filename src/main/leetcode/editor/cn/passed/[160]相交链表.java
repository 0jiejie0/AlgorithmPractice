package main.leetcode.editor.cn;//给你两个单链表的头节点 headA 和 headB ，请你找出并返回两个单链表相交的起始节点。如果两个链表不存在相交节点，返回 null 。
//
// 图示两个链表在节点 c1 开始相交： 
//
// 
...
//
// Related Topics 哈希表 链表 双指针 👍 2412 👎 0
...
class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (!nodeHashSet.contains(headB) && headB != null) {
            headB = headB.next;
        }
        return headB;
    }
...
// 	执行耗时:6 ms,击败了25.06% 的Java用户
//	内存消耗:46.6 MB,击败了98.62% 的Java用户