package main.problemAndSolving.lanqiao.lanqiao_20201111Compete_8.pro3;

import java.util.*;

class MyTree {
    private Map<String, List<String>> map_ch = new HashMap<String, List<String>>();// 节点名称-子节点名称列表
    private Map<String, String> map_pa = new HashMap<String, String>();// 节点名称-父节点
    ...
    private boolean last_child(String x) {// 判断一个节点是不是父节点的最后一个节点
    ...
    public void show(String x) {
        ...
        while (true) {
            ...
            if (pa == null)
                break;
            s = (last_child(pa) ? " " : "|") + space(4) + s;//比较简单
