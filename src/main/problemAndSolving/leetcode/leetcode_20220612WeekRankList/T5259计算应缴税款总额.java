package main.problemAndSolving.leetcode.leetcode_20220612WeekRankList;
...
public class T5259计算应缴税款总额 {
    public double calculateTax(int[][] brackets, int income) {
        double res = 0;
        if (income <= brackets[0][0]) {//最低档的税率
            return income * brackets[0][1] / 100.0;
        } else {
            res += brackets[0][0] * brackets[0][1];
            income -= brackets[0][0];
        }
        for (int i = 1; income > 0; i++) {//一档以上的税率
